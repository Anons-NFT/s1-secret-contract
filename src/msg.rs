...
use crate::royalties::{RoyaltyInfo,DisplayRoyaltyInfo};
...
pub struct InitMsg {
    ...
    /// list of whitelisted addresses for reserved minting
    pub whitelist_minters: Vec<HumanAddr>,
...
pub enum QueryMsg {
    ...
    /// information, mint run information and
